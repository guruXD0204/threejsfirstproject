...
pointLight2.position.set(2.13,-1.5,-1.98)
...
pointLight3.position.set(-2.64,1.59,-1.72)
...
const windowfX=window.innerWidth/2;
const windowfY=window.innerHeight/2;


function onDocumentMouseMove(event){
    mouseX=(event.clientX-windowfX)
    mouseY=(event.clientY-windowfY)
}
